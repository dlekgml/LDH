...
조건식 거짓이라면 첫번째 중괄호는 건너뛰고(jmp) else 뒤의 중괄호를 실행시킨다.
...
if(조건식){
    내용
}else if(조건식){    =>  실행될 내용이 3개 이상일때 사용
    내용
}else{
    내용
}
...
if(com==user){
    alert("비김");
}else if((com==1 && user==2) || (com==2 && usser==3 && userr==1)
    alert("승");
...
//     } 
// });
//         // alert("앞면선택"); // alert는 알림창을 나타내는 함수이다.
